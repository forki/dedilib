...
{
    [TestFixture]
    public class TestHashSetDictionary
    {
        [Test]
        public void Empty_CountAndValues()
        {
            ...
            Assert.That(sut.GetValuesAsHashSet(1), Is.Empty);
        ...
        public void Add_SingleKeySingleValue_CountAndValues()
        {
            ...
            Assert.That(sut.GetValuesAsHashSet(1), Is.EquivalentTo(new[] { 1000 }));
        ...
        public void Add_SingleKeyTwoValues_CountAndValues()
        {
            ...
            Assert.That(sut.GetValuesAsHashSet(1), Is.EquivalentTo(new[] { 1000, 2000 }));
            Assert.That(sut.Keys, Is.EquivalentTo(new[] { 1 }));
        ...
        public void Add_TwoKeysSingleValueEach_CountAndValues()
        {
            ...
            Assert.That(sut.GetValuesAsHashSet(1), Is.EquivalentTo(new[] { 1000 }));
            Assert.That(sut.GetValuesAsHashSet(2), Is.EquivalentTo(new[] { 2000 }));
        ...
        public void AddMany_SingleKeyThreeValues_CountAndValues()
        {
            ...
            Assert.That(sut.GetValuesAsHashSet(1), Is.EquivalentTo(new[] { 1000, 2000, 3000 }));
            Assert.That(sut.Keys, Is.EquivalentTo(new[] { 1 }));
        ...
        {
            var sut = new HashSetDictionary<int, int> { { 1, 1000 } };
        ...
        {
            var sut = new HashSetDictionary<int, int> { { 1, 1000 }, { 1, 2000 } };
        ...
        {
            var sut = new HashSetDictionary<int, int> { { 1, 1000 }, { 2, 2000 } };
